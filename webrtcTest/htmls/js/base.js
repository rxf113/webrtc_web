...
customSDK = {
    ...
    //呼叫
    callRemote: function (remoteId,times) {
        var data = {
            "data": {
                "info": {
                    "responder": remoteId
...
function sendMsg(msg) {
    ...
    var currentChannel = pc.createDataChannel("chat");
    console.log(currentChannel);
    currentChannel.onopen = function(event) {
        console.log(event);
        currentChannel.send('Hi!');
    };

    currentChannel.onmessage = function(event) {
